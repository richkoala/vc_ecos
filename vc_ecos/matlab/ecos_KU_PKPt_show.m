...
[mat_KU,]               = func_decode_matrix(strcat(path,'Mat_KU_setup.txt'));
[mat_PKPt_setup,]       = func_decode_matrix(strcat(path,'PKPt_setup.txt'));
[mat_PKPt_solve_init,]  = func_decode_matrix(strcat(path,'PKPt_solve_init.txt'));
