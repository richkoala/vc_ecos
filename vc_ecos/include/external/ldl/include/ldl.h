...
#if PROFILING == 3
void ldl_lsolve2 (int n, double B [], int Lp [ ], int Li [ ], double Lx [ ], double X [ ],int* ldl_lsolve2_cnt,pfloat* ldl_lsolve2_time) ;
void ldl_dsolve (int n, double X [ ], double D [ ],int* ldl_dsolve_cnt,pfloat* ldl_dsolve_time) ;
void ldl_ltsolve (int n, double X [ ], int Lp [ ], int Li [ ],double Lx [ ],int* ldl_ltsolve_cnt,pfloat* ldl_ltsolve_time) ;
#else
