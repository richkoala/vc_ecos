...
typedef struct demat_struct{
	union {
		double double_data1;
		struct {
			idxint frame_id_or_row;
			idxint frame_len_or_col;
		};
	};
	union {
		double double_data2;
...
//frame_info + vector x/b
typedef struct devec_struct{
	union {
		double double_data1;
		struct {
			idxint frame_id_or_cnt;
			idxint frame_len_or_iter_num;};
	};
} devec_struct;
